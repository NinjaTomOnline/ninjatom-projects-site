...
- `styles.css`: responsive dark-mode visual system for the hero, keyboard quick-find palette, combined Studio Notes / Latest Updates panel, controls, cards, detail drawer, 404 page, and footer
...
- Project cards: `app.js` uses real preview images when available, prefers screenshot-like project media over generic social/preview artwork, shows gallery-count badges for media-rich projects, and falls back to generated code-native preview panels when a project does not expose a screenshot yet.
